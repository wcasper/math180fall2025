...
\begin{frame}{Perfect Strategy}
  \begin{block}{First move?}
      ...
      $$(1,1): \ydiagram{4,4,4}\rightarrow \ydiagram{1,1,4}$$
      $$(3,3): \ydiagram{1,1,4}\rightarrow \ydiagram{1,1,3}$$
...
\begin{frame}{Perfect Strategy}
  \begin{block}{First move?}
      ...
      $$(1,1): \ydiagram{4,4,4}\rightarrow \ydiagram{1,4,4}$$
...
\begin{frame}{Perfect Strategy}
  \begin{block}{What about $(1,3)$?}
    ...
    \begin{center}
      \ydiagram{2,3,5}
    \end{center}
    This is a losing board! (check all cases)!
  \end{block}
\end{frame}
...
\pause
  \begin{block}{Puzzle}
    Suppose you start with a $5\times 6$ board.
